        ...
        >
          ...
          <div className="flex items-center gap-4">
            <input
              ...
              className="flex-1 px-4 py-3 border-2 border-gray-900 rounded-lg bg-white text-gray-900 font-medium focus:border-gray-900 focus:ring-2 focus:ring-gray-200"
            />
          </div>
        </motion.div>
